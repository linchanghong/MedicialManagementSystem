				...
				<c:otherwise>
					     ...
					     <table border="0" width="750" align="center">
										...
										<td align="right">
											...
											<a href="<%=contextPath %>/Register/queryAllDayEnd_q.action?currPage=${pageModel.previousPage}&oper=${oper}">上一页</a>
											<a href="<%=contextPath %>/Register/queryAllDayEnd_q.action?currPage=${pageModel.nextPage}&oper=${oper}">下一页</a>
...
<script type="text/javascript">
	...
	function changePage() {
		...
		window.self.location = "<%=contextPath %>/Register/queryAll.action?currPage="
              ...
              <p align="center"><a href="<%=contextPath %>/Register/queryAllDayEnd.action">返回</a></p>
</body>
</html>