   ...
   <form action="<%=contextPath %>/RegPatient/conditionquery.action" method="post">
        ...
        <table style="padding-left:100px" >
          <tr>
               ...
               <td><SELECT style="WIDTH: 100px;height:20px" name="queryType"> 
                   <OPTION selected value="regiserPatient_id">×¢²áºÅ</OPTION> 
                   <OPTION value="regiserPatient_caseNo">²¡ÀúºÅ</OPTION>
                   <OPTION value="regiserPatient_name">»¼ÕßÐÕÃû</OPTION> 
                   </SELECT>
               </td>
           </tr>
           <tr>
        ...
        <div>
           <c:choose>
             <c:when test="${empty list}">
			 	...
			 	<p align="center"><font color="red">Ã»ÓÐ»¼ÕßÐÅÏ¢!</font></p>
	...
	<table align="center" border="1" cellspacing="0" width="800">
     ...
     <tr>
        ...
        <td>
            &nbsp;ÁªÏµµç»°£º&nbsp;<input type="text" name="regPatient.regiserPatient_phoneNo" id="regiserPatient_phoneNo" class="text ui-widget-content ui-corner-all">
        </td>
     </tr>
     <tr>
        <td colspan="2">
