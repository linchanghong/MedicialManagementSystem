...
<div id="queryCondition">
        <form action="<%=contextPath %>/Register/query.action" method="post">
           ...
           <table style="padding-left:100px">
             <tr>
               ...
               <td><SELECT style="WIDTH: 100px;height:20px" name="queryType"> 
                   ...
                   <OPTION value="退号">退号</OPTION> 
                   </SELECT>
               </td>
               <td><input type="hidden" name="next1" value="next2"></td>
               <td><td><input type="submit" value="" style="background-image:url(../image/CRUD_image/query1.png);width: 100px; height: 30px"></td></td>
             </tr>
           </table>
        </form>
      </div>
				...
				<c:otherwise>
					     ...
					     <table border="0" width="750" align="center">
										...
										<td align="right">
											...
											<a href="<%=contextPath %>/Register/queryAll.action?currPage=${pageModel.previousPage}">上一页</a>
											<a href="<%=contextPath %>/Register/queryAll.action?currPage=${pageModel.nextPage}">下一页</a>
