...
<body background="">
      ...
      <div id="queryCondition">
        <form action="<%=contextPath %>/DoctorInfo/query.action" method="post">
           ...
           <table style="padding-left:100px">
             <tr>
               ...
               <td><SELECT style="WIDTH: 100px;height:20px" name="queryType">
                   ...
                   <OPTION selected value="doctorInfo_name">医生名</OPTION> 
                   <OPTION value="doctorInfo_age">医生年龄</OPTION>
                   <OPTION value="doctorInfo_sex">医生性别</OPTION> 
      ...
      <div id="showDetails">
           <c:choose>
                 <c:when test="${empty pageModel.list}">
								<tr>
									<td align="center">
										<p style="padding-left:300px"><font color="red">没有医生信息!</font></p>
									</td>
								</tr>
				</c:when>
				<c:otherwise>
                          <table border="1" width="750" align="center" cellpadding="0" cellspacing="0">
                                       ...
                                       <c:forEach items="${pageModel.list}" var="m">
											<tr align="center">
												<td>
													<!-- 医生名 -->
													<div class="title1">${m.doctorInfo_name}</div>
												</td>
												<td>
													<!-- 医生年龄 -->
													<div class="td1">${m.doctorInfo_age}</div>
												</td>
												<td>
													<!-- 医生性别 -->
													<div class="td1">${m.doctorInfo_sex}</div>
												</td>
												<td>
													<!-- 所属科室名 -->
												...
												<td>
												    <a href="<%=contextPath %>/DoctorInfo/modify1.action?doctorInfo_id=${m.doctorInfo_id}">修改</a>
												</td>
												<td>
												    <a id="deleteOrNot" href="<%=contextPath %>/DoctorInfo/delete.action?doctorInfo_id=${m.doctorInfo_id}">删除</a>
												</td>
											</tr>
								      </c:forEach>
					     </table>
					     ...
					     <table border="0" width="750" align="center">
										...
										<td align="right">
											...
											<a href="<%=contextPath %>/DoctorInfo/add.action?currPage=${pageModel.previousPage}">上一页</a>
											<a href="<%=contextPath %>/DoctorInfo/add.action?currPage=${pageModel.nextPage}">下一页</a>
...
<div id="newView" style=" display:none;"><jsp:include page="DoctorInfo_add.jsp"></jsp:include></div>
