           ...
           <table style="padding-left:100px">
             <tr>
               ...
               <td><SELECT style="WIDTH: 100px;height:20px" name="queryType"> 
                   ...
                   <OPTION value="deptInfo_name">科室名称</OPTION>
                   <OPTION value="deptInfo_zjm">科室助记码</OPTION> 
                   </SELECT>
                   </td>
             </tr>
             <tr>
      ...
      <div id="showDetails">
           <c:choose>
                 <c:when test="${empty pageModel.list}">
								<tr>
									<td align="center">
										<p style="padding-left:300px"><font color="red">没有科室信息!</font></p>
									</td>
								</tr>
				</c:when>
				<c:otherwise>
                          <table border="1" width="750" align="center" cellpadding="0" cellspacing="0">
                                       ...
                                       <c:forEach items="${pageModel.list}" var="m">
											<tr align="center">
												...
												<td>
												    <a href="<%=contextPath %>/DeptInfo/modify1.action?deptInfo_id=${m.deptInfo_id}">修改</a>
												</td>
												<td>
												    <a id="deleteOrNot" href="<%=contextPath %>/DeptInfo/delete.action?deptInfo_id=${m.deptInfo_id}">删除</a>
												</td>
											</tr>
								      </c:forEach>
					     </table>
					     ...
					     <table border="0" width="750" align="center">
										...
										<td align="right">
											...
											<a href="<%=contextPath %>/DeptInfo/add.action?currPage=${pageModel.previousPage}">上一页</a>
											<a href="<%=contextPath %>/DeptInfo/add.action?currPage=${pageModel.nextPage}">下一页</a>
